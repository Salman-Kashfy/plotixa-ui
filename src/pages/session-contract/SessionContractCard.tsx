...
export type SessionContractListRow = Record<string, ReactNode | string | number> & {
    id: string;
};

type SessionContractCardProps = {
    row: SessionContractListRow;
    columns: ListColumn[];
};

function SessionContractCard({ row, columns }: SessionContractCardProps) {
...
export default SessionContractCard;
